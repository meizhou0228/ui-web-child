...
export const PRESET_TASKS: PresetTaskSeed[] = [
  ...
  { categoryId: 'study', name: '认识今日课程表',        icon: 'memo',           points: 5,  timeSlot: 'morning', repeatable: 'daily' },
  { categoryId: 'study', name: '专注学习 20 分钟',      icon: 'puzzle',         points: 8,  timeSlot: 'daytime', repeatable: 'daily' },
  { categoryId: 'study', name: '练习写自己的名字',      icon: 'pencil',         points: 6,  timeSlot: 'daytime', repeatable: 'daily' },
  ...
  { categoryId: 'life',  name: '检查水杯和纸巾',        icon: 'bowl-of-food',   points: 4,  timeSlot: 'morning', repeatable: 'daily' },
  ...
  { categoryId: 'life',  name: '主动表达需要帮助',      icon: 'sparkles',       points: 5,  timeSlot: 'daytime', repeatable: 'daily', dailyLimit: 2 },
...
export const PRESET_WEEKLY_TASKS: PresetTaskSeed[] = [
  ...
  { categoryId: 'study', name: '完成一次模拟上课 30 分钟',  icon: 'abc',         points: 30, timeSlot: 'daytime', repeatable: 'once', weeklyLimit: 1 },
  ...
  { categoryId: 'life',  name: '本周独立整理书包 5 次',     icon: 'closed-book', points: 35, timeSlot: 'evening', repeatable: 'once', weeklyLimit: 1 },
];
